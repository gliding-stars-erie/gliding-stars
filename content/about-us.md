...
title: About Us
layout: about.njk
description: Learn about Gliding Stars of Erie—our 26-year history founded by
  Jack Schultz, how our adaptive skating program works, and the dedicated
...
history: >
  **In the fall of 1999**, Gliding Stars came to [Mercyhurst
  University](https://www.mercyhurst.edu/). Our founder Jack Schultz had seen
  the Gliding Stars program on _Real Sports with Bryant Gumbel_, and it inspired
  him to bring the program to Erie, Pennsylvania.
...
how_text: >
  ...
  individuals with disabilities the opportunity to maximize their personal
  potential through development of ice-skating skills in a consistent program of
  instruction and practice in our local community, culminating in the annual
...
what_list:
  ...
  - We skate once a week on Monday evenings at [Mercyhurst Ice
    Center](https://maps.app.goo.gl/v3A6BqgMfSiyFL2x7).
  - Each skater is equipped with properly fitted skates and any needed adaptive
    gear, including helmets, walkers, or gait trainers.
  - Skaters are paired with trained volunteers and guided by experienced
    instructors.
  - Weekly sessions are structured to include skill-building instruction, fun
    activities, and skating to music.
  - Throughout the year, we organize several fundraisers to help sustain the
    program.
  - At the end of the season, skaters showcase their progress in a full ice show.
  - Participants also have the opportunity to perform during an intermission at
    an [Erie Otters](https://ottershockey.com/) game.
  - The season wraps up with a celebratory banquet honoring all of our Stars and
    volunteers.
team_title: Our Team
team:
  - group: Leadership
  ...
  - group: Operations
    members:
      - "Equipment: Jim DiSanti, Betsey Gotham, Chris Gotham, Sean Gotham, Tim
        Hurst, Heidi Schultz"
      - "Fundraising: Terry Bowers, Barb DiSanti, Sue Moczulski, Cheryl Oleski,
        Gabby Ottavio"
