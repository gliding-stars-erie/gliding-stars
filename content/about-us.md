...
# OVERVIEW VIDEO
# =========================
# A YouTube video appears here automatically. To change the video, ask a developer
# to update the YouTube URL inside content/_layouts/about.njk.


# =========================
# HISTORY
# =========================
# The history section includes a floating photo on the right (desktop)
# and a blockquote styled in a separate font. Use **bold** and _italic_
# for emphasis within the text. Blockquotes start with > on each line.
...
# WHAT WE DO
# =========================
# A bulleted list displayed inside a highlighted info box.
# Each item supports markdown — you can include links using [text](url).
...
what_list:
  ...
  - Participants also have the opportunity to perform during an intermission at an [Erie Otters](https://ottershockey.com/) game.
